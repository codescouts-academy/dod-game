...
export function useGameState() {
  ...
  const startGame = useCallback(() => {
    ...
    const orderedBaseCards = orderCardsByCategory(dodCards);
  ...
  const totalCards = dodCards.length + gameState.customCards.length;
