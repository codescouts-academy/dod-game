import { DoDCard } from "@/data/dorCards";
...
export function GameSummary({
  ...
  const exportResults = () => {
    ...
    let text = `# Definition of Done - Resultados del equipo\n`;
    text += `Fecha: ${now}\n\n`;
    ...
    a.href = url;
    a.download = `dod-resultados-${now.replace(/\//g, "-")}.md`;
    a.click();
    ...
    <div className="animate-in fade-in-0 duration-700">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          Han definido su Definition of Done como equipo
        </p>
      </div>
